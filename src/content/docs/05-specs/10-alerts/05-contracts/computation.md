...
> Behaviour: [../02-specify.md](/05-specs/10-alerts/02-specify/) · API: [openapi.yaml](/05-specs/10-alerts/05-contracts/openapi/) · Entity: [data-model.md §8](/03-data/data-model/) · ADR: [ADR-016](/01-constitution/constitution/#adr-016--v1-action-required--concrete-items-only), [ADR-036](/01-constitution/constitution/#adr-036--alert-persistence-model)
